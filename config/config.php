...
define('__NAME__', 'host');

/* Set site */
define('__SALT__', '255d943bf821b38d386935b775a01a21'); // Salt
define('__ADMIN__', 'admin'); // Admin username
define('__TITLE__', 'Christmas CTF'); // Title
define('__RANK_REFRESH_DELAY__', 3000); // Rank refresh delay : 1000 = 1s, 60000 = 1m
define('__DOMAIN__', 'your domain'); // CSRF Mitigation
define('__ADMIN_PAGE__', '/admin'); // Admin page
